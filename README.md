...
* `--MPA=0/1`: Activate motion plane adaptive motion model
* `--GED=0/1`: Activate geodesic motion model
* `--ROT=0/1`: Activate rotational motion model
* `--TAN=0/1`: Activate tangential motion model
* `--3DT=0/1`: Activate 3D-translational motion model
